...
public:
    ...
    static ll NumberOfHoursInYear(short Year)
    {
        return NumberOfDaysInYear(Year) * 24;
    }

    ll NumberOfHoursInYear()
    {
        return NumberOfHoursInYear(_Year);
    }

    static ll NumberOfMinutesInYear(short Year)
    {
        return NumberOfHoursInYear(Year) * 60;
    }

    ll NumberOfMinutesInYear()
    {
        return NumberOfMinutesInYear(_Year);
    }

    static ll NumberOfSecondsInYear(short Year)
    {
        return NumberOfMinutesInYear(Year) * 60;
    }

    ll NumberOfSecondsInYear()
    {
